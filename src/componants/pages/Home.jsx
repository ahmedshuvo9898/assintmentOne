            ...
            <div className="row ab-info">
              <div className="col-md-6 ab-content ab-content1">
                <div className="ab-content-inner">
                  <a href="single.html">
                    <img
                      src="assats/images/services2.jpg"
                      alt="news image"
                      className="img-fluid"
                    />
                  </a>
              ...
              <div className="col-md-6 ab-content ab-content1">
                <div className="ab-content-inner">
                  <a href="single.html">
                    <img
                      src="assats/images/services1.jpg"
                      alt="news image"
                      className="img-fluid"
                    />
                  </a>
          ...
          <div className="container py-md-5">
            <div className="test-info text-center">
              ...
              <div className="read-more mx-auto m-0 text-center">
                <a href="contact.html" className="read-more scroll btn">
                  Click here
                </a>{" "}
              </div>
            </div>
